...
<body>
	...
	<div class="container">
		<table class="table table-bordered table-hover" style="text-align : center; border: 1px soolid #dddddd">
		<thead>
			<tr>
		...
		<tbody>
			...
			<tr>
				<td colspan="2"><button class="btn btn-primary pull-right" onclick="findFunction();" type="button">검색 </button>
			</tr>
		 </tbody>
		</table>
	</div>
